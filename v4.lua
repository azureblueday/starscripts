...
function module:tween(...) TweenService:Create(...):Play() end

local uis = game:GetService("UserInputService")

function module:create(Object, Properties, Parent)
...
function module:get_text_size(...)
    return text_service:GetTextSize(...)
end

function module:console(func)
    func(("\n"):rep(57))
end

module.signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/Quenty/NevermoreEngine/version2/Modules/Shared/Events/Signal.lua"))()
...
function module:set_draggable(gui)
...
function module.new(library_title, cfg_location)
    local menu = {}
    menu.values = {}
    menu.on_load_cfg = module.signal.new("on_load_cfg")
    ...
    menu.open = true
    local ScreenGui = module:create("ScreenGui", {
        ResetOnSpawn = false,
    ...
    local Cursor = module:create("ImageLabel", {
        Name = "Cursor",
    ...
    local MobileToggle
    if isMobile then
        MobileToggle = module:create("ImageButton", {
            Name = "MobileToggle",
            AnchorPoint = Vector2.new(1, 0),
            BackgroundColor3 = Color3.fromRGB(15, 15, 15),
            BorderColor3 = Color3.fromRGB(138, 43, 226),
    ...
    local ImageLabel = module:create("ImageButton", {
        Name = "Main",
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(15, 15, 15),
        BorderColor3 = Color3.fromRGB(138, 43, 226),
        Position = UDim2.new(0.5, 0, 0.5, 0),
        Size = isMobile and UDim2.new(0.9, 0, 0.8, 0) or UDim2.new(0, 700, 0, 500),
    ...
    module:set_draggable(ImageLabel)

    local Title = module:create("TextLabel", {
        Name = "Title",
    ...
    local TabButtons = module:create("Frame", {
        Name = "TabButtons",
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local UIListLayout = module:create("UIListLayout", {
        HorizontalAlignment = Enum.HorizontalAlignment.Center
    }, TabButtons)

    local Tabs = module:create("Frame", {
        Name = "Tabs",
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    function menu.new_tab(tab_image)
        ...
        local TabButton = module:create("TextButton", {
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            BackgroundTransparency = 1,
        ...
        local TabImage = module:create("ImageLabel", {
            AnchorPoint = Vector2.new(0.5, 0.5),
            BackgroundTransparency = 1,
            Position = UDim2.new(0.5, 0, 0.5, 0),
        ...
        local TabSections = module:create("Frame", {
            Name = "TabSections",
            Parent = Tab,
            BackgroundTransparency = 1,
        ...
        local TabFrames = module:create("Frame", {
            Name = "TabFrames",
            BackgroundTransparency = 1,
        ...
        if is_first_tab then
            ...
            TabImage.ImageColor3 = Color3.fromRGB(138, 43, 226)
            Tab.Visible = true
        end
        ...
        TabButton.MouseButton1Down:Connect(function()
            ...
            for _,TButtons in pairs (TabButtons:GetChildren()) do
                ...
                module:tween(TButtons.ImageLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(100, 100, 100)})
            end
            ...
            Tab.Visible = true
            selected_tab = TabButton
            module:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(138, 43, 226)})
        end)
        TabButton.MouseEnter:Connect(function()
            if selected_tab == TabButton then return end

            module:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(255, 255, 255)})
        end)
        TabButton.MouseLeave:Connect(function()
            if selected_tab == TabButton then return end

            module:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(100, 100, 100)})
        end)
        ...
        function tab.new_section(section_name)
            ...
            local SectionButton = module:create("TextButton", {
                Name = "SectionButton",
                BackgroundTransparency = 1,
            ...
            SectionButton.MouseEnter:Connect(function()
                ...
                module:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
            end)
            SectionButton.MouseLeave:Connect(function()
                if selected_section == SectionButton then return end

                module:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(100, 100, 100)})
            end)

            local SectionDecoration = module:create("Frame", {
            ...
            local UIGradient = module:create("UIGradient", {
                Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(32, 33, 38)), ColorSequenceKeypoint.new(0.5, Color3.fromRGB(138, 43, 226)), ColorSequenceKeypoint.new(1, Color3.fromRGB(32, 33, 38))},
            }, SectionDecoration)

            local SectionFrame = module:create("Frame", {
                Name = "SectionFrame",
                BackgroundTransparency = 1,
                Size = UDim2.new(1, 0, 1, 0),
                Visible = false,
            ...
            local Left = module:create("Frame", {
                Name = "Left",
                BackgroundTransparency = 1,
            ...
            local Right = module:create("Frame", {
                Name = "Right",
                BackgroundTransparency = 1,
            ...
            SectionButton.MouseButton1Down:Connect(function()
                for _,SectionButtons in pairs (TabSections:GetChildren()) do
                    if SectionButtons:IsA("UIListLayout") then continue end
                    module:tween(SectionButtons, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(100, 100, 100)})
                ...
                module:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(138, 43, 226)})
            ...
            if is_first_section then
                ...
                SectionButton.TextColor3 = Color3.fromRGB(138, 43, 226) 
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                local Border = module:create("Frame", {
                    BackgroundColor3 = Color3.fromRGB(5, 5, 5),
                    BorderColor3 = Color3.fromRGB(30, 30, 30),
                    Size = UDim2.new(1, 0, 0, 20),
                }, actual_side)

                local Container = module:create("Frame", {
                ...
                local UIPadding = module:create("UIPadding", {
                    PaddingTop = UDim.new(0, 12),
                }, Container)

                local SectorTitle = module:create("TextLabel", {
                    Name = "Title",
                    AnchorPoint = Vector2.new(0.5, 0),
                    BackgroundTransparency = 1,
                ...
                function sector.create_line(thickness)
                    ...
                    local LineFrame = module:create("Frame", {
                        Name = "LineFrame",
                        BackgroundTransparency = 1,
                    ...
                    local Line = module:create("Frame", {
                        Name = "Line",
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    if type == "Toggle" then
                        ...
                        local ToggleButton = module:create("TextButton", {
                            Name = "Toggle",
                            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                            BackgroundTransparency = 1,
                            Position = UDim2.new(0, 0, 0, 0),
                        ...
                        local ToggleFrame = module:create("Frame", {
                        ...
                        local ToggleText = module:create("TextLabel", {
                            BackgroundTransparency = 1,
                        ...
                        function element:set_value(new_value, cb)
                            ...
                            if value.Toggle then
                                module:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(138, 43, 226)})
                                module:tween(ToggleText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                            else
                                module:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(30, 30, 30)})
                                if not mouse_in then
                                    module:tween(ToggleText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                                end
                            end
                        ...
                        function element:add_keybind(key_default, key_callback)
                            ...
                            local Keybind = module:create("TextButton", {
                                Name = "Keybind",
                                AnchorPoint = Vector2.new(1, 0),
                                BackgroundTransparency = 1,
                            ...
                            local KeybindFrame = module:create("Frame", {
                                Name = "KeybindFrame",
                                BackgroundColor3 = Color3.fromRGB(10, 10, 10),
                                BorderColor3 = Color3.fromRGB(30, 30, 30),
                            ...
                            Keybind.MouseEnter:Connect(function()
                                keybind_in = true
                                module:tween(Keybind, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                            end)
                            Keybind.MouseLeave:Connect(function()
                                keybind_in = false
                                module:tween(Keybind, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                            end)
                            KeybindFrame.MouseEnter:Connect(function()
                                keybind_in2 = true
                                module:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(138, 43, 226)})
                            end)
                            KeybindFrame.MouseLeave:Connect(function()
                                keybind_in2 = false
                                module:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(30, 30, 30)})
                            end)
                            ...
                            local Always = module:create("TextButton", {
                                Name = "Always",
                                BackgroundTransparency = 1,
                            ...
                            local Hold = module:create("TextButton", {
                                Name = "Hold",
                                BackgroundTransparency = 1,
                                Size = UDim2.new(1, 0, 0, 25),
                                Font = Enum.Font.Ubuntu,
                            ...
                            local Toggle = module:create("TextButton", {
                                Name = "Toggle",
                                BackgroundTransparency = 1,
                                Size = UDim2.new(1, 0, 0, 25),
                                Font = Enum.Font.Ubuntu,
                            ...
                            for _,TypeButton in next, KeybindFrame:GetChildren() do
                                ...
                                TypeButton.MouseEnter:Connect(function()
                                    if extra_value.Type ~= TypeButton.Text then
                                        module:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                                    end
                                end)
                                TypeButton.MouseLeave:Connect(function()
                                    if extra_value.Type ~= TypeButton.Text then
                                        module:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                                    end
                                end)
                                TypeButton.MouseButton1Down:Connect(function()
                                    ...
                                    for _,TypeButton2 in next, KeybindFrame:GetChildren() do
                                        ...
                                        module:tween(TypeButton2, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                                    end
                                    module:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(138, 43, 226)})
                                end)
                            end
                            ...
                            uis.InputBegan:Connect(function(input)
                                if is_binding then
									...
									Keybind.Size = UDim2.new(0, module:get_text_size(Keybind.Text, 14, Enum.Font.Ubuntu, Vector2.new(700, 20)).X + 3, 0, 20)
                            ...
                            Keybind.MouseButton1Down:Connect(function()
								if not is_binding then
									...
									is_binding = true
									Keybind.Text = "[ ... ]"
									Keybind.Size = UDim2.new(0, module:get_text_size("[ ... ]", 14, Enum.Font.Ubuntu, Vector2.new(700, 20)).X + 3,0, 20)
								end
							end)
                            ...
                            function keybind:set_value(new_value, cb)
                                ...
                                for _,TypeButton2 in next, KeybindFrame:GetChildren() do
                                    ...
                                    if TypeButton2.Name ~= extra_value.Type then
                                        ...
                                        module:tween(TypeButton2, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(138, 43, 226)})
                                    end
                                end
                        ...
                        function element:add_color(color_default, has_transparency, color_callback)
                            ...
                            local ColorButton = module:create("TextButton", {
                                Name = "ColorButton",
                            ...
                            local ColorFrame = module:create("Frame", {
                                Name = "ColorFrame",
                                Parent = ColorButton,
                                BackgroundColor3 = Color3.fromRGB(10, 10, 10),
                                BorderColor3 = Color3.fromRGB(0, 0, 0),
                            ...
                            local ColorPicker = module:create("ImageButton", {
                                Name = "ColorPicker",
                                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                                BorderColor3 = Color3.fromRGB(0, 0, 0),
                            ...
                            local ColorPick = module:create("Frame", {
                                Name = "ColorPick",
                                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                                BorderColor3 = Color3.fromRGB(0, 0, 0),
                            ...
                            local HuePicker = module:create("TextButton", {
                                Name = "HuePicker",
                                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                                BorderColor3 = Color3.fromRGB(0, 0, 0),
                            ...
                            local HuePick = module:create("ImageButton", {
                                Name = "HuePick",
                                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                                BorderColor3 = Color3.fromRGB(0, 0, 0),
                                Size = UDim2.new(1, 0, 0, 1),
                            ...
                            ColorFrame.MouseEnter:Connect(function()
                                in_color = true
                                module:tween(ColorFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(138, 43, 226)})
                            end)
                            ColorFrame.MouseLeave:Connect(function()
                                in_color = false
                                module:tween(ColorFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(0, 0, 0)})
                            end)
                            ...
                            if has_transparency then
                                ...
                                local TransparencyPicker = module:create("ImageButton", {
                                ...
                                TransparencyColor = module:create("ImageLabel", {
                                    BackgroundTransparency = 1,
                                    Size = UDim2.new(1, 0, 1, 0),
                                ...
                                TransparencyPick = module:create("Frame", {
                    ...
                    elseif type == "Dropdown" then
                        ...
                        local Dropdown = module:create("TextLabel", {
                            Name = "Dropdown",
                            BackgroundTransparency = 1,
                        ...
                        local DropdownButton = module:create("TextButton", {
                            Name = "DropdownButton",
                            BackgroundColor3 = Color3.fromRGB(25, 25, 25),
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
                        ...
                        local DropdownButtonText = module:create("TextLabel", {
                        ...
                        local ImageLabel = module:create("ImageLabel", {
                            BackgroundTransparency = 1,
                        ...
                        local DropdownText = module:create("TextLabel", {
                            Name = "DropdownText",
                            BackgroundTransparency = 1,
                        ...
                        local DropdownScroll = module:create("ScrollingFrame", {
                            Name = "DropdownScroll",
                            Active = true,
                            BackgroundColor3 = Color3.fromRGB(25, 25, 25),
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
                        ...
                        DropdownButton.MouseButton1Down:Connect(function()
                            ...
                            if not dropdown_open then
                                module:tween(DropdownText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                                module:tween(DropdownButtonText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                            else
                                module:tween(DropdownText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                                module:tween(DropdownButtonText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                            end
                        end)
                        ...
                        for _,v in next, data.options do
                            local Button = module:create("TextButton", {
                                Name = v,
                                BackgroundColor3 = Color3.fromRGB(25, 25, 25),
                                BorderColor3 = Color3.fromRGB(0, 0, 0),
                                BorderSizePixel = 0,
                            ...
                            local Decoration = module:create("Frame", {
                                Name = "Decoration",
                            ...
                            Button.MouseEnter:Connect(function()
                                module:tween(ButtonText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                                Decoration.Visible = true
                            end)
                            Button.MouseLeave:Connect(function()
                                module:tween(ButtonText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                        ...
                        for _,v in next, data.options do
                            ...
                            Button.MouseEnter:Connect(function()
                                ...
                                if not table.find(value.Combo, v) then
                                    module:tween(ButtonText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(200, 200, 200)})
                                end
                            end)
                            Button.MouseLeave:Connect(function()
                                mouse_in = false
                    ...
                    elseif type == "Button" then
                        ...
                        local ButtonFrame = module:create("Frame", {
                            Name = "ButtonFrame",
                            BackgroundTransparency = 1,
                            Position = UDim2.new(0, 0, 0, 0),
                        ...
                        Button.MouseEnter:Connect(function()
                            module:tween(Button, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                        end)
                        Button.MouseLeave:Connect(function()
                            module:tween(Button, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                        end)
                        Button.MouseButton1Down:Connect(function()
                            Button.BorderColor3 = Color3.fromRGB(138, 43, 226)
                            module:tween(Button, TweenInfo.new(0.6, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(0, 0, 0)})
                            do_callback()
                        end)
                    elseif type == "TextBox" then
                        ...
                        local TextBox = module:create("TextBox", {
                            Name = "Button",
                            AnchorPoint = Vector2.new(0.5, 0.5),
                            BackgroundColor3 = Color3.fromRGB(25, 25, 25),
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
                        ...
                        TextBox.MouseEnter:Connect(function()
                            module:tween(TextBox, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                        end)
                        TextBox.MouseLeave:Connect(function()
                            module:tween(TextBox, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                        end)
                        ...
                        uis.TextBoxFocused:connect(function()
                            if uis:GetFocusedTextBox() == TextBox then
                                module:tween(TextBox, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(138, 43, 226)})
                            end
                        end)
                        uis.TextBoxFocusReleased:connect(function()
                            module:tween(TextBox, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(0, 0, 0)})
                        end)
                    ...
                    elseif type == "Scroll" then
                        ...
                        local Scroll = module:create("Frame", {
                            Name = "Scroll",
                            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                            BackgroundTransparency = 1,
                            Position = UDim2.new(0, 0, 0, 0),
                        ...
                        local ScrollFrame = module:create("ScrollingFrame", {
                            Name = "ScrollFrame",
                            Active = true,
                            BackgroundColor3 = Color3.fromRGB(25, 25, 25),
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
                        ...
                        ScrollFrame.MouseEnter:Connect(function()
                            module:tween(ScrollFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(50, 50, 50)})
                        end)
                        ScrollFrame.MouseLeave:Connect(function()
                            module:tween(ScrollFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(0, 0, 0)})
                        end)
                        ...
                        for _,v in next, data.options do
                            ...
                            Button.MouseButton1Down:Connect(function()
                                for _,Button2 in next, ScrollFrame:GetChildren() do
                                    ...
                                    module:tween(Button2.ButtonText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                                end
                        ...
                        function element:set_value(new_value, cb)
                            ...
                            module:tween(ScrollFrame[value.Scroll].ButtonText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                    ...
                    elseif type == "Slider" then
                        ...
                        local Slider = module:create("Frame", {
                            Name = "Slider",
                            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                            BackgroundTransparency = 1,
                        ...
                        local SliderText = module:create("TextLabel", {
                            Name = "SliderText",
                            BackgroundTransparency = 1,
                            Position = UDim2.new(0, 9, 0, 6),
                            Size = UDim2.new(0, 200, 0, 9),
                        ...
                        local SliderButton = module:create("TextButton", {
                            Name = "SliderButton",
                            BackgroundColor3 = Color3.fromRGB(25, 25, 25),
                            BorderColor3 = Color3.fromRGB(0, 0, 0),
                            Position = UDim2.new(0, 9, 0, 20),
                        ...
                        local SliderFrame = module:create("Frame", {
                            Name = "SliderFrame",
                            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                            BorderSizePixel = 0,
                        ...
                        local UIGradient = module:create("UIGradient", {
                            Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(138, 43, 226)), ColorSequenceKeypoint.new(1, Color3.fromRGB(90, 0, 90))},
                            Rotation = 90,
                        }, SliderFrame)

                        local SliderValue = module:create("TextLabel", {
                            Name = "SliderValue",
                            BackgroundTransparency = 1,
                        ...
                        Slider.MouseEnter:Connect(function()
                            module:tween(SliderText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})
                            module:tween(SliderValue, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)})

                            mouse_in = true
                        end)
                        Slider.MouseLeave:Connect(function()
                            if not is_sliding then
                                module:tween(SliderText, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                                module:tween(SliderValue, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(150, 150, 150)})
                            end
